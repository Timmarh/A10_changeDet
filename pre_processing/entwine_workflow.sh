...
entwine build -c ./config-reproject.json \
	-i $DATA_PATH/2018/filtered_las/ \
	-o $DATA_PATH/2018/entwined-4978/
echo 'tiled 2018 to epsg 4978'

entwine build -c ./config-reproject.json \
        -i $DATA_PATH/2019/filtered_las/ \
        -o $DATA_PATH/2019/entwined-4978/
echo 'tiled 2019 to epsg 4978'

entwine convert \
	-i $DATA_PATH/2018/entwined-4978/ \
	-o $DATA_PATH/2018/cesium/
echo 'converted 2018 to cesium';
entwine convert \
	-i $DATA_PATH/2019/entwined-4978/ \
	-o $DATA_PATH/2019/cesium/
